...
public class AcceptedInfoDAO extends BasicDAO implements IAcceptedInfoDAO {
	...
	public void insert(AcceptedInfo acceptedInfo) throws DAOException {
		try {
			...
			insertProcessLog(TableName.ACCEPTEDINFO, acceptedInfo.getId());
			em.flush();
	...
	public void update(AcceptedInfo acceptedInfo) throws DAOException {
		try {
			...
			updateProcessLog(TableName.ACCEPTEDINFO, acceptedInfo.getId());
			em.flush();
		} catch (PersistenceException pe) {
	...
	@Transactional(propagation = Propagation.REQUIRED)
	public AcceptedInfo findByReferenceNo(String referenceNo, ReferenceType referenceType) throws DAOException {
