...
public class AcceptedInfoService extends BaseService implements IAcceptedInfoService {
	...
	public void addNewAcceptedInfo(AcceptedInfo acceptedInfo) {
		try {
			acceptedInfo.setPrefix(getPrefix(AcceptedInfo.class));
	...
	public AcceptedInfo findAcceptedInfoByReferenceNo(String referenceNo, ReferenceType referenceType) {
		AcceptedInfo result = null;
		try {
			result = acceptedInfoDAO.findByReferenceNo(referenceNo, referenceType);
		} catch (DAOException e) {
