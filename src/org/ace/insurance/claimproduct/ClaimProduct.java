...
public class ClaimProduct implements Serializable {
	...
	@JoinTable(name = "CLAIMPRODUCT_KEYFACTOR_LINK", joinColumns = { @JoinColumn(name = "CLAIMPRODUCTID", referencedColumnName = "ID") }, inverseJoinColumns = { @JoinColumn(name = "KEYFACTORID", referencedColumnName = "ID") })
