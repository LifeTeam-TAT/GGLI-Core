...
@Embeddable
public class FamilyInfoHistory implements Serializable {
	...
	public FamilyInfoHistory() {
		tempId = System.nanoTime() + "";
	}

	public FamilyInfoHistory(FamilyInfo familyinfo) {
		this.initialId = familyinfo.getInitialId();
		this.idNo = familyinfo.getIdNo();
	...
	public FamilyInfoHistory(FamilyInfoDto familyInfoDto) {
	...
	public FamilyInfoHistory(String initialId, String idNo, IdType idType, Date dateOfBirth, Name name, RelationShip relationShip, Industry industry, Occupation occupation) {
