...
public class ProductProcessIDConfig {
	...
	private static String PUBLIC_TEMLIFE_ID="PUBLIC_TEMLIFE_ID";
	...
	public static String getPublicTermlifeProposalProcessId() {
		return idConfig.getProperty(PUBLIC_TEMLIFE_ID);
	}
