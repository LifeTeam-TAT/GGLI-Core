...
public class DateUtils {
	...
	public static int getPeriodOfMonth(int period, org.ace.insurance.web.common.PeriodType periodType) {
		int periodOfMonth = period;
		if (periodType.equals(org.ace.insurance.web.common.PeriodType.DAY)) {
			periodOfMonth = period / 31;
		} else if (periodType.equals(org.ace.insurance.web.common.PeriodType.YEAR)) {
