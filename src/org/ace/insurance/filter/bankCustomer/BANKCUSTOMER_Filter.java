...
public class BANKCUSTOMER_Filter extends BasicDAO implements IBANKCUSTOMER_Filter {
	...
	public List<BANKCUSTOMER001> find(BANKCUST001 item, String value) {
		List<BANKCUSTOMER001> result = new ArrayList<BANKCUSTOMER001>();
		...
		switch (item) {
			...
			case DESCRIPTION: {
				...
				break;
			case CODE: {
				bufferer.append("WHERE c.acode like '%" + value + "%'");
			}
				break;
		}
		...
		for (Object[] obj : objectList) {
			...
			result.add(new BANKCUSTOMER001(id, name, description, code));
		}
		return result;
	}
}
