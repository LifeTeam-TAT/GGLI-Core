package org.ace.insurance.life.bancassurance.proposalhistory;
...
@Entity
@Table(name = TableName.BANCAASSURANCEPROPOSALHISTORY)
@TableGenerator(name = "BANCAASSURANCEPROPOSAL_HISTORY_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "BANCAASSURANCEPROPOSAL_HISTORY_GEN", allocationSize = 10)
@EntityListeners(IDInterceptor.class)
public class BancaassuranceProposalHistory implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "BANCAASSURANCEPROPOSAL_HISTORY_GEN")
	private String id;
	...
	public BancaassuranceProposalHistory(BancaassuranceProposal bancaassuranceProposal) {
		// this.referenceId = bancaassuranceProposal.getId();
		...
		this.lifeProposal = bancaassuranceProposal.getLifeProposal();
		this.travelProposal = bancaassuranceProposal.getTravelProposal();
		this.personTravelProposal = bancaassuranceProposal.getPersonTravelProposal();
		this.medicalProposal = bancaassuranceProposal.getMedicalProposal();
		this.bancaRefferal = bancaassuranceProposal.getBancaRefferal();
		this.bancaBranch = bancaassuranceProposal.getBancaBranch();
		this.version = bancaassuranceProposal.getVersion();
		this.commonCreateAndUpateMarks = bancaassuranceProposal.getCommonCreateAndUpateMarks();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BancaassuranceProposalHistory other = (BancaassuranceProposalHistory) obj;
		if (bancaBRM == null) {
