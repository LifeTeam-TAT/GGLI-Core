...
@NamedQueries(value = {
		@NamedQuery(name = "ClaimAmount.findAll", query = "SELECT c FROM LifeClaimAmount c "),
...
public class LifeClaimAmount implements Serializable, IEntity{
	...
	public LifeClaimAmount(PolicyInsuredPerson policyInsuredPerson , String claimRole ,double claimAmount ,
			double netAmount ,double loanAmount , double loanInterest,double renewelAmount , double renewelInterest) {
