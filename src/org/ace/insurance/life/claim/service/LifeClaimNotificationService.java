...
import org.ace.insurance.web.manage.life.claim.LifeClaimNotiCriteria;
...
public class LifeClaimNotificationService implements ILifeClaimNotificationService {
	...
	public void addNewLifeClaimNotification(LifeClaimNotification notification) {
		try {
			...
			notificationNo = customIDGenerator.getNextId(SystemConstants.LIFE_CLAIM_NOTIFICATION_NO, null, true);
