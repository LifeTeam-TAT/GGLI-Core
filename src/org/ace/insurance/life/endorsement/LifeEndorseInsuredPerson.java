...
@NamedQueries(value = {
		@NamedQuery(name = "LifeEndorseInsuredPerson.findAll", query = "SELECT lp FROM LifeEndorseInsuredPerson lp "),
...
/****************************************************** getter / setter **********************************************************/
	...
	public void setInsuredPersonEndorseStatus(
			InsuredPersonEndorseStatus insuredPersonEndorseStatus) {
	...
	public void setLifeEndorseChangeList(
			List<LifeEndorseChange> lifeEndorseChangeList) {
