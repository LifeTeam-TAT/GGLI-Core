...
public class LifePolicyTimeLineLogService implements ILifePolicyTimeLineLogService {
	...
	public void addLifePolicyEndorseLog(LifePolicyEndorseLog lifePolicyEndorseLog) {
		try {
			String prefix = customIDGenerator.getPrefix(LifePolicyEndorseLog.class, false);
			lifePolicyEndorseLog.setPrefix(prefix);
	...
	public void addLifePolicyIdLog(LifePolicyIdLog lifePolicyIdLog) {
		try {
			String prefix = customIDGenerator.getPrefix(LifePolicyIdLog.class, false);
			lifePolicyIdLog.setPrefix(prefix);
	...
	public void addLifePolicyTimeLineLog(LifePolicyTimeLineLog lifePolicyTimeLineLog) {
		try {
			String prefix = customIDGenerator.getPrefix(LifePolicyTimeLineLog.class, false);
			lifePolicyTimeLineLog.setPrefix(prefix);
	...
	public void addLifePolicyClaimLog(LifePolicyClaimLog lifePolicyClaimLog) {
		try {
			String prefix = customIDGenerator.getPrefix(LifePolicyClaimLog.class, false);
			lifePolicyClaimLog.setPrefix(prefix);
