...
public class LifePolicyPremiumDAO extends BasicDAO implements ILifePolicyPremiumDAO {
	...
	public void insert(LifePolicyPremium lifePolicyPremium) throws DAOException {
		try {
			...
			insertProcessLog(TableName.LIFEPOLICYPREMIUM, lifePolicyPremium.getId());
			em.flush();
		} catch (PersistenceException pe) {
	...
	public void update(LifePolicyPremium lifePolicyPremium) throws DAOException {
		try {
			...
			updateProcessLog(TableName.LIFEPOLICYPREMIUM, lifePolicyPremium.getId());
			em.flush();
		} catch (PersistenceException pe) {
	...
	public List<LifePolicyPremium> findByLifePolicyPremium(String lifePolicyNo, String customerID, String agentID,
		...
		try {
			...
			if (lifePolicyNo == null && customerID == null && agentID == null &&
