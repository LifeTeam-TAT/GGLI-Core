...
public class LifeProposalInsuredPersonHistory {
	...
	public LifeProposalInsuredPersonHistory(Date dateOfBirth, double proposedSumInsured, Product product, LifeProposalHistory lifeproposalHistory, int periodMonth, Date startDate,
			Date endDate, double proposedPremium, String initialId, String idNo, IdType idType, Name name, Gender gender, ResidentAddress residentAddress, Occupation occupation,
			String fatherName, double endorsementNetBasicPremium, double endorsementNetAddonPremium, double interest, EndorsementStatus status, String insPersonCodeNo,
			Boolean isPaidPremiumForPaidup, Customer customer, int age, String inPersonGroupCodeNo) {
	...
	public LifeProposalInsuredPersonHistory(Date dateOfBirth, double proposedSumInsured, Product product, LifeProposalHistory lifeproposalHistory, int periodMonth, Date startDate,
			Date endDate, double proposedPremium, double endorsementNetBasicPremium, double endorsementNetAddonPremium, double interest, EndorsementStatus status,
			String insPersonCodeNo, String inPersonGroupCodeNo) {
		this.dateOfBirth = dateOfBirth;
		this.proposedSumInsured = proposedSumInsured;
		this.product = product;
		this.lifeProposalHistory = lifeproposalHistory;
