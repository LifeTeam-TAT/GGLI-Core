...
@NamedQueries(value = { @NamedQuery(name = "ClaimInitialReport.findAll", query = "SELECT r FROM ClaimInitialReport r Order by r.claimReportNo"),
		@NamedQuery(name = "ClaimInitialReport.findAllActiveClaim", query = "SELECT r FROM ClaimInitialReport r WHERE r.claimStatus IN (org.ace.insurance.medical.claim.ClaimStatus.CLAIM_APPLIED,org.ace.insurance.medical.claim.ClaimStatus.INITIAL_INFORM)  Order by r.claimReportNo"),
...
public class ClaimInitialReport implements Serializable {
	...
	@JoinColumn(name = "CLAIMINITIALREPORTID")
