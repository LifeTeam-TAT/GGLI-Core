...
public class DeathClaimICD10 {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((commonCreateAndUpateMarks == null) ? 0
						: commonCreateAndUpateMarks.hashCode());
		result = prime * result
				+ ((deathClaim == null) ? 0 : deathClaim.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (commonCreateAndUpateMarks == null) {
			if (other.commonCreateAndUpateMarks != null)
				return false;
		} else if (!commonCreateAndUpateMarks
				.equals(other.commonCreateAndUpateMarks))
			return false;
		if (deathClaim == null) {
