...
public class MC001 implements ISorter {
	...
	public MC001(String id, String policyNo, String saleMan, String agent, String branch, String unit, double totalClaimAmount, Date submittedDate, String claimRequestNo,
			String receivedNo) {
		this.id = id;
