...
public class MedicalClaimBeneDAO extends BasicDAO implements IMedicalClaimBeneDAO {
	 ...
	 * medicalClaimInsuredPerson.getId()); em.flush();System.gc(); } catch
	 ...
	 * em.merge(deathPerson); updateProcessLog(TableName.DEATH_PERSON,
	 * deathPerson.getId()); em.flush();System.gc(); } catch (PersistenceException pe) {
	 * throw translate("failed to update medicalClaimInsuredPerson", pe); } }
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	 ...
	 * q.getSingleResult(); em.flush();System.gc(); } catch (PersistenceException pe) {
	 * throw
