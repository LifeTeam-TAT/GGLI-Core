...
public class MedicalPolicyHistoryService implements IMedicalPolicyHistoryService {
	...
	public void addNewMedicalPolicyHistory(MedicalPolicy medicalPolicy, PolicyStatus status, PolicyHistoryEntryType entryType) {
		try {
			...
			medicalPolicyHistory.setSaleMan(medicalPolicy.getSaleMan());
			...
			medicalPolicyHistory.setSalePoint(medicalPolicy.getSalePoint());
			...
			medicalPolicyHistory.setEntryType(entryType);
			setPrefix(medicalPolicyHistory);
	   ...
	   private void setPrefix(MedicalPolicyEditHistory medicalPolicyHistory) {
		String lPolicyPrefix = customIDGenerator.getPrefix(MedicalPolicyEditHistory.class, true);
		medicalPolicyHistory.setPrefix(lPolicyPrefix);
