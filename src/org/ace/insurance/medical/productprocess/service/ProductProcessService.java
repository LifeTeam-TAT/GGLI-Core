...
public class ProductProcessService extends BaseService implements IProductProcessService {
	...
	public void addNewProductProcess(ProductProcess productProcess) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to add a new ProductProcess", e);
		}
	}
	...
	public void updateProductProcess(ProductProcess productProcess) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to update a ProductProcess", e);
		}
	}
	...
	public void deleteProductProcess(ProductProcess productProcess) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to delete a ProductProcess", e);
		}
	}
	...
	public List<ProductProcess> findAllProductProcess() {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find all of ProductProcess)", e);
		}
		return result;
	}
	...
	public List<ProductProcess> findProductProcessBySurveyQuestionId(String surveyQuestionId) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find all of ProductProcess by surveyQuestion)", e);
		}
		return result;
	}
	...
	public ProductProcess findByProductProcessId(String productProcessId) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find ProductProcess by id)", e);
		}
		return result;
	}
	...
	public List<ProductProcess> findProPByActiveStatus() {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find ProductProcess by activeStatus)", e);
		}
		return result;
	}
	...
	public int findPPCountByQuId(String surveyQuestionId) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find ProductProcess's by surveyQuestionId)", e);
		}
		return count;
	}
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRED)
	public List<ProductProcess> findOldConfPP(String productId, String processId) {
		List<ProductProcess> result = null;
		try {
			result = productProcessDAO.findOldConfPP(productId, processId);
		} catch (DAOException e) {
			throw new SystemException(e.getErrorCode(), "Faield to find old configure ProductProcess by productId and processId)", e);
		}
		return result;
	}
	...
	public List<ProductProcess> findConfigAndDeactivatePP(String productId, String processId) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find old configure and deactivate ProductProcess by productId and processId)", e);
		}
		return result;
	}
	...
	public List<String> findPNoByProductAndProcess(String productId, String processId) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find ProductProcess's QueSetNo by productId and processId)", e);
		}
		return result;
	}
}
