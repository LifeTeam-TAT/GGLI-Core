...
public interface ISurveyQuestionDAO {
	 ...
	 */
	public List<ProductProcessQuestionLink> findPProQueByPPId(String productId, String processId, ProductProcessCriteriaDTO productProcessCriteriaDTO) throws DAOException;
	...
	List<ProductProcessQuestionLink> findMedicalPProQueByPPIdMedical(String productName, String processName, StudentAgeType studentAgeType) throws DAOException;
