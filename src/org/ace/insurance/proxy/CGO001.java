...
public class CGO001 implements Serializable, ISorter, IDataModel {
	...
	public CGO001(String id, String proposalNo, String customerId, Name customer, String orgnization, Date submittedDate, Date createdDate, String currency, Double sumInsured) {
		this.id = id;
