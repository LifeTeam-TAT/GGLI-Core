...
public class FCL001 implements ISorter {
	private String id;
	...
	public FCL001(String id, String claimReferenceNo, String policyNo, String customerName, Date pendingSince, double totalClaimAmount, double surveyRemainingValue,
