...
public class FCL002 implements ISorter {
	...
	public FCL002(String id, String claimReferenceNo, String policyNo, String customerName, String salePersonName, String branch, double totalClaimAmount) {
		this.id = id;
