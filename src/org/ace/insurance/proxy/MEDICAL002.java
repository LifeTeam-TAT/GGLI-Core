...
public class MEDICAL002 implements Serializable, ISorter, IDataModel {
	...
	public MEDICAL002(String id, String proposalNo, Name cusName, String orgName, Date submittedDate, Date pendingSince) {
		this.id = id;
		this.proposalNo = proposalNo;
		this.customerName = cusName != null ? cusName.getFullName() : orgName;
