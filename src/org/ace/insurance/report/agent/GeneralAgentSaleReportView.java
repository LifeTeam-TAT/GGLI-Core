...
public class GeneralAgentSaleReportView {
	...
	public GeneralAgentSaleReportView(String id, String agentId, String agentName, String agentCodeNo, Date commissionStartDate, int motorPolicyCount, double motorPremium,
			double motorCommission, int firePolicyCount, double firePremium, double fireCommission, int cargoPolicyCount, double cargoPremium, double cargoCommission,
			int cisPolicyCount, double cisPremium, double cisCommission, int citPolicyCount, double citPremium, double citCommission, int totalPolicyCount, double totalPremium,
			double totalCommission, String branchId, String branchName, String salePointName) {
		super();
		this.id = id;
