...
public class LifeAgentSaleReportView {
	...
	public LifeAgentSaleReportView(String agentId, String agentName, String agentCodeNo, Date commissionStartDate, int publicLifeCount, double publicLifePremium,
			double publicLifeCommission, int groupLifeCount, double groupLifePremium, double groupLifeCommission, int medicalPolicyCount, double medicalPremium,
			double medicalCommission, int snakeBitePolicyCount, double snakeBitePremium, double snakeBiteCommission, int sportMenPolicyCount, double sportMenPremium,
			double sportMenCommission, int travelPolicyCount, double travelPremium, double travelCommission, int totalPolicyCount, double totalPremium, double totalCommission,
			String branchId, String branchName, String salePointName) {
		super();
