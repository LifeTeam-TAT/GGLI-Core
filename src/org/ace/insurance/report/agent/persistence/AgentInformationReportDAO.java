		...
		try {
			...
			if (criteria.getSearchType() != null) {
				switch (criteria.getSearchType()) {
					case AGENT_CODE: {
						query.append(" AND f.codeNo like :codeNo");
						break;
					}
					case NRCNO:
					case FRCNO:
			...
			if (criteria.getSearchType() != null) {
				switch (criteria.getSearchType()) {
					case AGENT_CODE: {
						q.setParameter("codeNo", "%" + criteria.getAgent() + "%");
						break;
					}
					case NRCNO: {
