...
public class ProposalPremiumSummaryReportDAO extends BasicDAO implements IProposalPremiumSummaryReportDAO {
	...
	public List<ProposalPremiumSummaryReport> find(SummaryReportCriteria criteria) throws DAOException {
		...
		try {
			...
			// faq.append(" SELECT SUM(a.proposedPremium),a.name FROM
			// FireProposalSummary a ");
			...
			// fsq.append(" SELECT SUM( s.proposedPremium ),s.name FROM
			// FireProposalSummary s ");
			...
			// maq.append(" SELECT SUM( a.proposedPremium ),a.name FROM
			// MotorProposalSummary a ");
			...
			// msq.append(" SELECT SUM( s.proposedPremium ),s.name FROM
			// MotorProposalSummary s ");
			...
			// result.add(new ProposalPremiumSummaryReport(salemanMotorList,
			// agentMotorList, motorProductList, "Motor Insurance"));
			// result.add(new ProposalPremiumSummaryReport(salemanFireList,
			// agentFireList, fireProductList, "Fire Insurance"));
