...
public class ProposalSummaryReportDAO extends BasicDAO implements IProposalSummaryReportDAO {
	...
	public List<ProposalSummaryReport> find(SummaryReportCriteria criteria) throws DAOException {
		...
		try {
			...
			// maq.append(" SELECT COUNT(a.id),a.name FROM MotorProposalSummary
			// a ");
			...
			// msq.append(" SELECT COUNT(s.id),s.name FROM MotorProposalSummary
			// s ");
			...
			// result.add(new ProposalSummaryReport(salemanMotorList,
			// agentMotorList, motorProductList, "Motor Insurance"));
			// result.add(new ProposalSummaryReport(salemanFireList,
