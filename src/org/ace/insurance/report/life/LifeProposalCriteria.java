...
public class LifeProposalCriteria {
	...
	public LifeProposalCriteria(Date startDate, Date endDate, Agent agent, Customer customer, Organization organization, Branch branch, Product product, Entitys entity) {
