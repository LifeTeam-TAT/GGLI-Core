...
public class LifeDailyIncomeReportService implements ILifeDailyIncomeReportService {
	...
	public List<LifeDailyIncomeReport> findLifeDailyIncome(LifeDailyIncomeReportCriteria lifeDailyIncomeCriteria, List<String> productIdList) {
		List<LifeDailyIncomeReport> result = null;
		try {
			result = lifeDailyIncomeReportDAO.find(lifeDailyIncomeCriteria, productIdList);
	...
	public void generateLifeDailyIncomeReport(List<LifeDailyIncomeReport> reportList, String dirPath, String fileName, String branch) {
		try {
			...
			for (LifeDailyIncomeReport report : reportList) {
	...
	private double getTotalAmount(List<LifeDailyIncomeReport> reportList) {
		double totalAmount = 0.0;
		for (LifeDailyIncomeReport lifeDailyIncomeReport : reportList) {
