...
public class HealthMonthlyReport implements ISorter {
	...
	public HealthMonthlyReport(String id, Date activedPolicyStartDate, String policyNo, String branchId ,String salePointName, String insuredPersonName, Gender gender, Date dateOfBirth, int age,
			String fullIdNo, String occupation, String address, String paymentType, Double premium, String receiptNo, Date paymentDate, String beneficiaryName, String relationship,
			int unit, int basicPlusUnit, int addOn1, int addOn2, String salePersonName, CustomerType customerType, String salePersonType, double commission, String productId,
			String proposalNo) {
		this.id = id;
