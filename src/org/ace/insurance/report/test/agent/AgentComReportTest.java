...
public class AgentComReportTest {
	...
	public void prepareReport() throws Exception {
		List<AgentCommissionDetailReport> agentComReports = new ArrayList<AgentCommissionDetailReport>();
		// AgentCommissionDetailReport agentCommissionDetailReport = new
		// AgentCommissionDetailReport("agentCode", "liscenseNo", "agentName",
		// "phNo", "address", "policyNo", 1000.0,
		// PolicyReferenceType.FIRE_POLICY, "remark", new Date(), "invoiceNo",
		// "");
		// agentCommissionDetailReport.setBusinessType("businessType");
		// agentComReports.add(agentCommissionDetailReport);
