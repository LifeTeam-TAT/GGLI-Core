...
public class LifePolicyLedgerTest {
	...
	public void test() {
		try {
			...
			String endYear = String.valueOf(policyEndDate.getYear() + insuredPerson.getPeriodYears());
			...
			paramMap.put("occupation", lifePolicy.getCustomer() == null ? "" : lifePolicy.getCustomer().getOccupation() == null ? "" : lifePolicy.getCustomer().getOccupation()
					.getName());
			...
			paramMap.put("timeSlotList", insuredPerson.getTimeSlotList());
