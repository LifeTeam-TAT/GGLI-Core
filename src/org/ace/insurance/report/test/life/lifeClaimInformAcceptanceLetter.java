...
//	@Test
	public  void generateLifeDeathClaimAcceptanceLetter() {
	    ...
	    ClaimAcceptedInfo claimAcceptedInfo  = claimAcceptedInfoService.findClaimAcceptedInfoByReferenceNo("referenceNo", ReferenceType.LIFE_CLAIM);
		try {
	       ...
	       // paramMap.put("totalAmount", lifeClaim.getTotalNetClaimAmount());
			...
			throw new SystemException(ErrorCode.SYSTEM_ERROR,
					"Failed to generate LifeClaimAcceptanceLetter", e);
		}
	}
