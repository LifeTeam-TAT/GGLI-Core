package org.ace.insurance.system.common.channel;
...
@Entity
@Table(name = TableName.CHANNEL)
@TableGenerator(name = "CHANNEL_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "CHANNEL_GEN", allocationSize = 10)
@EntityListeners(IDInterceptor.class)
public class Channel implements Serializable {

	private static final long serialVersionUID = 1L;
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "CHANNEL_GEN")
	private String id;
	private String name;
