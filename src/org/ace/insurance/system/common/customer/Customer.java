...
public class Customer implements Serializable {
	...
	public Customer(InsuredPersonInfoDTO insuredPersonDto) {
		this.initialId = insuredPersonDto.getInitialId();
		this.fatherName = insuredPersonDto.getFatherName();
		this.idNo = insuredPersonDto.getIdNo();
		this.fullIdNo = insuredPersonDto.getFullIdNo();
		this.dateOfBirth = insuredPersonDto.getDateOfBirth();
		this.gender = insuredPersonDto.getGender();
		this.idType = insuredPersonDto.getIdType();
		this.name = insuredPersonDto.getName();
		this.weight = insuredPersonDto.getWeight();
		this.residentAddress = insuredPersonDto.getResidentAddress();
		this.occupation = insuredPersonDto.getOccupation();
		this.height = insuredPersonDto.getHeight();
		this.fullIdNo = insuredPersonDto.getFullIdNo();
		this.contentInfo = insuredPersonDto.getContentInfo();
	}
