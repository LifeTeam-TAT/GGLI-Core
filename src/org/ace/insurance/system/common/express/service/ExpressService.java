...
public class ExpressService extends BaseService implements IExpressService {
	...
	public void addNewExpress(Express express) {
		try {
			express.setPrefix(getPrefix(Express.class));
			expressDAO.insert(express);
		} catch (DAOException e) {
			throw new SystemException(e.getErrorCode(), "Failed to add a new Express", e);
		}
	}
	...
	public void updateExpress(Express express) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to update a Express", e);
		}
	}
	...
	public void deleteExpress(Express express) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to delete a Express", e);
		}
	}
	...
	public List<Express> findAllExpress() {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find all of Express)", e);
		}
		return result;
	}
	...
	public Express findExpressById(String id) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find a Express (ID : " + id + ")", e);
		}
		return result;
	}
	...
	public List<Express> findExpressByCriteria(ExpressCriteria criteria, int max) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Failed to find by criteria.", e);
		}
		return result;
	}
	...
	public List<Express001> findExpressByCriteria001(ExpressCriteria criteria, int max) {
		...
		try {
			result = expressDAO.findByCriteria001(criteria, max);
		} catch (DAOException e) {
			throw new SystemException(e.getErrorCode(), "Failed to find by criteria.", e);
		}
		return result;
