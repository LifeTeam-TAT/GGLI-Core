package org.ace.insurance.system.common.staff;
...
@Entity
@Table(name = TableName.STAFF)
@TableGenerator(name = "STAFF_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "STAFF_GEN", allocationSize = 10)
@NamedQueries({ @NamedQuery(name = "staff.findAll", query = "select s from Staff s"), @NamedQuery(name = "staff.findById", query = "select s from Staff s where s.id =:id"),
		@NamedQuery(name = "staff.findStaffWithGGIOrganization", query = "select s from Staff s where s.ggiOrganization.id =:ggiId") })
...
public class Staff implements Serializable {
	...
	@JoinColumn(name = "GGIORGANIZATIONID", referencedColumnName = "ID")
	...
	public int hashCode() {
		...
		result = prime * result + ((ggiOrganization == null) ? 0 : ggiOrganization.hashCode());
		long temp;
	...
	public boolean equals(Object obj) {
		...
		if (gender != other.gender)
			return false;
		if (ggiOrganization == null) {
			if (other.ggiOrganization != null)
				return false;
		} else if (!ggiOrganization.equals(other.ggiOrganization))
			return false;
