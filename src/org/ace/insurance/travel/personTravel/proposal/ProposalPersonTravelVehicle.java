...
@Entity
@Table(name = TableName.PROPOSALPERSONTRAVEL_VEHICLE)
@TableGenerator(name = "PROPOSALPERSONTRAVEL_VEHICLE_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "PROPOSALPERSONTRAVEL_VEHICLE_GEN", allocationSize = 10)
@NamedQueries(value = { @NamedQuery(name = "ProposalPersonTravelVehicle.findAll", query = "SELECT v FROM ProposalPersonTravelVehicle v"),
		@NamedQuery(name = "ProposalPersonTravelVehicle.findById", query = "SELECT v FROM ProposalPersonTravelVehicle v WHERE v.id=:id") })
@EntityListeners(IDInterceptor.class)
public class ProposalPersonTravelVehicle implements Serializable {

	private static final long serialVersionUID = -4773681398880162309L;

	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "PROPOSALPERSONTRAVEL_VEHICLE_GEN")
	private String id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProposalPersonTravelVehicle other = (ProposalPersonTravelVehicle) obj;
