...
public class VersionRefDAO extends BasicDAO implements IVersionRefDAO {
	...
	public void insert(VersionRef versionRef) throws DAOException {
		try {
			...
			insertProcessLog(TableName.WSVERSIONREF, versionRef.getId());
			em.flush();
	...
	@Transactional(propagation = Propagation.REQUIRED)
	public List<VersionRefDTO> findIndexesByGroup(String groupName) throws DAOException {
		...
		try {
			...
			throw translate("Failed to find Version Reference indexes records of given group: ", pe);
		}
		return result;
	}

	@Transactional(propagation = Propagation.REQUIRED)
	public List<VersionRef> findUpdatesByGroupAndEntity(String entityName, String groupName, int versionNo) throws DAOException {
		List<VersionRef> result = new ArrayList<VersionRef>();
		try {
			Query query = em.createNamedQuery("VersionRef.findUpdatesByGroupAndEntityName");
			query.setParameter("group", groupName);
			...
			throw translate("Failed to find Updated Version Reference records of given group and entity with version No.: ", pe);
		}
		return result;
	}

	@Transactional(propagation = Propagation.REQUIRED)
	public List<VersionRef> findUpdatesByGroup(String groupName, int versionNo) throws DAOException {
		List<VersionRef> result = new ArrayList<VersionRef>();
		try {
			...
			throw translate("Failed to find Updated Version Reference records of given group and version No.: ", pe);
		}
		return result;
	}
	...
	public List<VersionRef> findAllByGroup(String groupName) throws DAOException {
		...
		try {
			...
			throw translate("Failed to find All Updated Version Reference records of given group: ", pe);
		}
		return result;
	...
	@Transactional(propagation = Propagation.REQUIRED)
	public int findMaximumVersionNo(String groupName, String entityName) throws DAOException {
		int maxVersionNo = 0;
		try {
			Query query = em.createNamedQuery("VersionRef.findMaxVersionNoByGroupAndEntityName");
			query.setParameter("group", groupName);
			query.setParameter("entityName", entityName);
			...
			throw translate("Failed to find maximum version number of given group: " + groupName + " entity: " + entityName, pe);
		}
		return maxVersionNo;
	}
	...
	@Transactional(propagation = Propagation.REQUIRED)
	public List<VersionRef> findUpdatesByEntityId(String entityId) throws DAOException {
		List<VersionRef> result = new ArrayList<VersionRef>();
		try {
			...
			throw translate("Failed to find All Updated Version Reference records by given Entity Id: " + entityId, pe);
		}
		return result;
	}
