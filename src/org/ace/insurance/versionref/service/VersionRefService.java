...
public class VersionRefService extends BaseService implements IVersionRefService {
	...
	public void addNewVersionRef(VersionRef versionRef) {
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to add a new Version Ref", e);
		}
	}
	...
	public List<VersionRef> findAllVersionRef() {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find all Version Ref", e);
		}
		return ret;
	}
	...
	public VersionRef findVersionRefById(String id) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find Version Ref given id :" + id, e);
		}
		return ret;
	}
	...
	public List<VersionRefDTO> findVersionRefIndexesByGroup(String groupName) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find Version Ref by given group :" + groupName, e);
		}
		return ret;
	}

	@Transactional(propagation = Propagation.REQUIRED)
	public List<VersionRef> findVersionRefUpdateByGroupAndEntity(String entityName, String groupName, int versionNo) {
		List<VersionRef> ret = null;
		try {
			ret = versionRefDAO.findUpdatesByGroupAndEntity(entityName, groupName, versionNo);
		} catch (DAOException e) {
			throw new SystemException(e.getErrorCode(), "Faield to find Version Ref by given group :" + groupName + " version No. :" + versionNo + " entity :" + entityName, e);
		}
		return ret;
	}

	@Transactional(propagation = Propagation.REQUIRED)
	public List<VersionRef> findVersionRefUpdateByGroup(String groupName, int versionNo) {
		List<VersionRef> ret = null;
		try {
			ret = versionRefDAO.findUpdatesByGroup(groupName, versionNo);
		} catch (DAOException e) {
			throw new SystemException(e.getErrorCode(), "Faield to find Version Ref by given group :" + groupName + " version No. :" + versionNo, e);
		}
		return ret;
	}
	...
	public int findMaximumVersionNo(String groupName, String entityName) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find maximum version number of given group:" + groupName + " entity name:" + entityName, e);
		}
		return maxVersionNo;
	}
	...
	public List<VersionRef> findVersionRefByEntityId(String entityId) {
		...
		try {
			...
			throw new SystemException(e.getErrorCode(), "Faield to find Version Ref by given entity Id: " + entityId, e);
		}
		return ret;
	}
}
