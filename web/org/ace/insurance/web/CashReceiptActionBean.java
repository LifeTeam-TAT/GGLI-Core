...
public class CashReceiptActionBean extends BaseBean implements Serializable {
	...
	public void filter() {
		selectedConfirmationList = null;
		if (criteria.getReferenceType().equals(WorkflowReferenceType.LIFE_PROPOSAL)) {
			tableTitle = "Life Proposals Confirmation";
		}
	...
	public String[] getReferenceTypeSelectedItemList() {
		return new String[] { "FIRE PROPOSAL", "MOTOR PROPOSAL", "LIFE PROPOSAL" };
	}
	...
	public void setReferenceTypeValue(String referenceTypeValue) {
		if (referenceTypeValue != null && !referenceTypeValue.isEmpty()) {
			if (referenceTypeValue.equals("LIFE PROPOSAL")) {
				criteria.setReferenceType(WorkflowReferenceType.LIFE_PROPOSAL);
			}
		}
