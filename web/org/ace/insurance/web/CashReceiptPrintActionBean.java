...
public class CashReceiptPrintActionBean extends BaseBean implements Serializable {
	...
	public void init() {
		...
		referenceType = (WorkflowReferenceType) getParam("WorkFlowType");
	}
	...
	public void confirmProposalList() {
		try {
			...
			if (referenceType.equals(WorkflowReferenceType.LIFE_PROPOSAL)) {
	...
	public void generateReport() {
		...
		if (criteria.getReferenceType().equals(WorkflowReferenceType.LIFE_PROPOSAL)) {
			DocumentBuilder.generateLifeCashReceiptList(lifeCashReceiptList, getDirPath(), getReportName() + ".pdf");
		}
	}
