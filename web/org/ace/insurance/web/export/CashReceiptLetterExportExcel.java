...
public class CashReceiptLetterExportExcel extends BaseBean implements ExportExcel {
	...
	public void generate(OutputStream op) throws IOException {
		...
		cellForDiscountAmount.setCellValue(payment.getDiscountAmount());
		...
		cellForAccDiscountAmount.setCellValue(payment.getDiscountAmount());
		...
		cellForMedDiscountAmount.setCellValue(payment.getDiscountAmount());
