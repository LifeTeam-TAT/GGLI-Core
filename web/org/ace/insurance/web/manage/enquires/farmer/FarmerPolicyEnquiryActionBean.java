...
@ViewScoped
@ManagedBean(name = "FarmerPolicyEnquiryActionBean")
public class FarmerPolicyEnquiryActionBean extends BaseBean implements Serializable {
	...
	private List<LPL002> farmerPolicyList;
	...
	public List<LPL002> getFarmerPolicyList() {
		return farmerPolicyList;
	}
	...
	public void ShowDetailFarmerPolicy(String lifePolicyId) {
	...
	public void findFarmerPolicyListByEnquiryCriteria() {
		...
		farmerPolicyList = lifePolicyService.findLifePolicyByEnquiryCriteria(criteria);
		sortLists(farmerPolicyList);
	}
	...
	public void resetCriteria() {
		...
		criteria.setNumber("");
		farmerPolicyList = new ArrayList<LPL002>();
	...
	public String editFarmerPolicy(String lifePolicyId) {
		LifePolicy lifePolicy = lifePolicyService.findLifePolicyById(lifePolicyId);
	...
	private final String reportName = "FarmerPremiumLedgerReport";
