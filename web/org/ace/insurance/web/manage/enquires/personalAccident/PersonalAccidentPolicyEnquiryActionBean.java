...
@ViewScoped
@ManagedBean(name = "PersonalAccidentPolicyEnquiryActionBean")
public class PersonalAccidentPolicyEnquiryActionBean extends BaseBean implements Serializable {
	...
	public String editLifePolicy(String lifePolicyId) {
		...
		putParam("PA_PRODUCT", InsuranceType.PERSONAL_ACCIDENT);
		putParam("lifePolicy", lifePolicy);
		return "editLifePolicy";
	}

	private final String reportName = "PersonalAccidentPremiumLedgerReport";
	...
	public void selectProduct() {
		selectProduct(InsuranceType.PERSONAL_ACCIDENT);
	}
}
