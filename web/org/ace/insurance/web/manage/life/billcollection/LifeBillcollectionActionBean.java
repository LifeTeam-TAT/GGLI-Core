...
public class LifeBillcollectionActionBean extends BaseBean implements Serializable {
	...
	public String OK() {
		...
		if (responsiblePerson == null) {
			...
			workFlowDTO = new WorkFlowDTO("", "", WorkflowTask.BILL_COLLECT_PAYMENT, WorkflowReferenceType.LIFE_COLLECTION, user, responsiblePerson);
			if (paymentChannel) {
	...
	public void selectUser() {
		selectUser(WorkflowTask.BILL_COLLECT_PAYMENT, WorkFlowType.LIFE);
	}
