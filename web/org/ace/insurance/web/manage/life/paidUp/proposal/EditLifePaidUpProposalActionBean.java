...
public class EditLifePaidUpProposalActionBean extends BaseBean implements Serializable {
	...
	public String updateLifePaidUpProposal() {
		String result = null;
		try {
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(null, remark, WorkflowTask.APPROVAL, WorkflowReferenceType.LIFE_PAIDUP_PROPOSAL, user, responsiblePerson);
	...
	public int getPeriodYears() {
		...
		int periodMonth = insuredPerson.getPeriodMonth();
		return periodMonth / 12;
	}

	public void selectUser() {
		selectUser(WorkflowTask.APPROVAL, WorkFlowType.LIFE_PAIDUP);
	}
