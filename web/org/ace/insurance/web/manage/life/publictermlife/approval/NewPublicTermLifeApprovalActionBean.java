package org.ace.insurance.web.manage.life.publictermlife.approval;
...
@ViewScoped
@ManagedBean(name = "NewPublicTermLifeApprovalActionBean")
public class NewPublicTermLifeApprovalActionBean extends BaseBean implements Serializable {
	...
	public void selectUser() {
		...
		selectUser(workflowTask, WorkFlowType.PUBLIC_TERM_LIFE);
	}

	public String redriectLifeApproval() {
		String result = null;
		try {
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.APPROVAL, WorkflowReferenceType.PUBLIC_TERM_LIFE_PROPOSAL, user,
					responsiblePerson);
	...
	public String approveLifeProposal() {
		...
		try {
			...
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.INFORM, WorkflowReferenceType.PUBLIC_TERM_LIFE_PROPOSAL, user, responsiblePerson);
