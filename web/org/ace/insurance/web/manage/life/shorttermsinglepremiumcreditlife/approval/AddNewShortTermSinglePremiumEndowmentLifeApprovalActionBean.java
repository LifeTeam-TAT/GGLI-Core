package org.ace.insurance.web.manage.life.shorttermsinglepremiumcreditlife.approval;
...
@ViewScoped
@ManagedBean(name = "AddNewShortTermSinglePremiumEndowmentLifeApprovalActionBean")
public class AddNewShortTermSinglePremiumEndowmentLifeApprovalActionBean extends BaseBean implements Serializable {
	...
	public void selectUser() {
		...
		selectUser(workflowTask, WorkFlowType.SHORT_TERM_SINGLE_PREMIUM_CREDIT_LIFE);
	}

	public String redriectLifeApproval() {
		String result = null;
		try {
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.APPROVAL, WorkflowReferenceType.SINGLE_PREMIUM_ENDOWMENT_LIFE_PROPOSAL, user,
					responsiblePerson);
	...
	public String approveLifeProposal() {
		...
		try {
			...
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.INFORM, WorkflowReferenceType.SHORT_TERM_SINGLE_PREMIUM_CREDIT_LIFE_PROPOSAL, user,
					responsiblePerson);
