package org.ace.insurance.web.manage.life.simplelife.approval;
...
@ViewScoped
@ManagedBean(name = "AddNewSimpleLifeApprovalActionBean")
public class AddNewSimpleLifeApprovalActionBean extends BaseBean implements Serializable {
	...
	public void selectUser() {
		...
		selectUser(workflowTask, WorkFlowType.SIMPLE_LIFE);
	}

	public String redriectLifeApproval() {
		String result = null;
		try {
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.APPROVAL, WorkflowReferenceType.SIMPLE_LIFE_PROPOSAL, user, responsiblePerson);
