...
package org.ace.insurance.web.manage.life.singlepremiumendowmentlife.approval;
...
@ViewScoped
@ManagedBean(name = "AddNewSinglePremiumEndowmentLifeApprovalActionBean")
public class AddNewSinglePremiumEndowmentLifeApprovalActionBean extends BaseBean implements Serializable {
	...
	public void selectUser() {
		...
		selectUser(workflowTask, WorkFlowType.SINGLE_PREMIUM_ENDOWMENT_LIFE);
	}
	...
	public String approveLifeProposal() {
		...
		try {
			...
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.INFORM, WorkflowReferenceType.SINGLE_PREMIUM_ENDOWMENT_LIFE_PROPOSAL, user,
					responsiblePerson);
