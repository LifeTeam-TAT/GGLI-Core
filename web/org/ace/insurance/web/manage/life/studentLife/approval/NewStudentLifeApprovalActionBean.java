package org.ace.insurance.web.manage.life.studentLife.approval;
...
public class NewStudentLifeApprovalActionBean extends BaseBean implements Serializable {
	...
	public String redriectLifeApproval() {
		String result = null;
		try {
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.APPROVAL, WorkflowReferenceType.STUDENT_LIFE_PROPOSAL, user, responsiblePerson);
	...
	public String approveLifeProposal() {
		...
		try {
			...
			WorkFlowDTO workFlowDTO = new WorkFlowDTO(lifeProposal.getId(), remark, WorkflowTask.INFORM, WorkflowReferenceType.STUDENT_LIFE_PROPOSAL, user, responsiblePerson);
