...
public class HospitalizedClaimFactory {
	public static HospitalizedClaim createHospitalizedClaim(HospitalizedClaimDTO hospitalizedClaimDTO) {
		...
		if (hospitalizedClaimDTO.getCommonCreateAndUpateMarks() != null) {
			hospitalizedClaim.setCommonCreateAndUpateMarks(hospitalizedClaimDTO.getCommonCreateAndUpateMarks());
		}
	...
	public static HospitalizedClaimDTO createHospitalizedClaimDTO(HospitalizedClaim hospitalizedClaim) {
		...
		if (hospitalizedClaim.getCommonCreateAndUpateMarks() != null) {
			hospitalizedClaimDTO.setCommonCreateAndUpateMarks(hospitalizedClaim.getCommonCreateAndUpateMarks());
		}
