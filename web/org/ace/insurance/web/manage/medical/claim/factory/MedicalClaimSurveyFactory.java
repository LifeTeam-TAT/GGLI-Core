...
public class MedicalClaimSurveyFactory {
	public static MedicalClaimSurvey createMedicalClaimSurvey(MedicalClaimSurveyDTO medicalClaimSurveyDTO) {
		...
		if (medicalClaimSurveyDTO.getCommonCreateAndUpateMarks() != null) {
			medicalClaimSurvey.setCommonCreateAndUpateMarks(medicalClaimSurveyDTO.getCommonCreateAndUpateMarks());
		}
	...
	public static MedicalClaimSurveyDTO createMedicalClaimSurveyDTO(MedicalClaimSurvey medicalClaimSurvey) {
		...
		if (medicalClaimSurvey.getCommonCreateAndUpateMarks() != null) {
			medicalClaimSurveyDTO.setCommonCreateAndUpateMarks(medicalClaimSurvey.getCommonCreateAndUpateMarks());
		}
