...
public class MedicalPolicyFactory {
	...
	public static MedicalPolicy createMedicalPolicy(MedicalPolicyDTO medicalPolicyDTO) {
		...
		medicalPolicy.setNilExcess(medicalPolicyDTO.isNilExcess());
		...
		medicalPolicy.setTotalDiscountAmount(medicalPolicyDTO.getTotalDiscountAmount());
		medicalPolicy.setStandardExcess(medicalPolicyDTO.getStandardExcess());
		...
		medicalPolicy.setReferral(medicalPolicyDTO.getReferral());
		...
		medicalPolicy.setSaleMan(medicalPolicyDTO.getSaleMan());
		...
		if (medicalPolicyDTO.getCommonCreateAndUpateMarks() != null) {
			medicalPolicy.setCommonCreateAndUpateMarks(medicalPolicyDTO.getCommonCreateAndUpateMarks());
		}
	...
	public static MedicalPolicyDTO createMedicalPolicyDTO(MedicalPolicy medicalPolicy) {
		...
		medicalPolicyDTO.setNilExcess(medicalPolicy.isNilExcess());
		...
		medicalPolicyDTO.setTotalDiscountAmount(medicalPolicy.getTotalDiscountAmount());
		medicalPolicyDTO.setStandardExcess(medicalPolicy.getStandardExcess());
		...
		medicalPolicyDTO.setReferral(medicalPolicy.getReferral());
		medicalPolicyDTO.setOrganization(medicalPolicy.getOrganization());
		medicalPolicyDTO.setApprovedBy(medicalPolicy.getApprovedBy());
		...
		medicalPolicyDTO.setSaleMan(medicalPolicy.getSaleMan());
		medicalPolicyDTO.setCustomerType(medicalPolicy.getCustomerType());
		medicalPolicyDTO.setSalePoint(medicalPolicy.getSalePoint());
		...
		if (medicalPolicy.getCommonCreateAndUpateMarks() != null) {
			medicalPolicyDTO.setCommonCreateAndUpateMarks(medicalPolicy.getCommonCreateAndUpateMarks());
		}
