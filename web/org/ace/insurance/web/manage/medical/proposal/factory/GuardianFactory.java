...
public class GuardianFactory {
	public static MedicalProposalInsuredPersonGuardian getGuardian(MedProGuardianDTO dto) {
		...
		guardian.setSameCustomer(dto.isSameCustomer());
		if (dto.getCommonCreateAndUpateMarks() != null) {
			guardian.setCommonCreateAndUpateMarks(dto.getCommonCreateAndUpateMarks());
		}
		return guardian;
	}
	...
	public static MedProGuardianDTO getGuardianDTO(MedicalProposalInsuredPersonGuardian guardian) {
		...
		if (guardian.getCommonCreateAndUpateMarks() != null) {
			dto.setCommonCreateAndUpateMarks(guardian.getCommonCreateAndUpateMarks());
		}
		return dto;
	}
