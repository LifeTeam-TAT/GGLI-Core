...
public class MedicalProposalAttachmentFactory {
	...
	public static MedProAttDTO getMedicalProposalAttachmentDTO(MedicalProposalAttachment attachment) {
		...
		if (attachment.getCommonCreateAndUpateMarks() != null) {
			medProAttDTO.setCommonCreateAndUpateMarks(attachment.getCommonCreateAndUpateMarks());
		}
	...
	public static MedicalProposalAttachment getMedicalProposalAttachment(MedProAttDTO attDTO) {
		...
		if (attDTO.getCommonCreateAndUpateMarks() != null) {
			medProAtt.setCommonCreateAndUpateMarks(attDTO.getCommonCreateAndUpateMarks());
		}
		return medProAtt;
	}
