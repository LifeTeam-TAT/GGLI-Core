...
public class MedicalSurveyDTOFactory {
	public static MedicalSurveyDTO getMedicalSurveyDTO(MedicalSurvey medicalSurvey) {
		...
		medicalSurveyDTO.setMedicalproposal(medicalSurvey.getMedicalProposal());
		...
		if (medicalSurvey.getCommonCreateAndUpateMarks() != null) {
			medicalSurveyDTO.setCommonCreateAndUpateMarks(medicalSurvey.getCommonCreateAndUpateMarks());
		}
	...
	public static MedicalSurvey getMedicalSurvey(MedicalSurveyDTO medicalSurveyDTO) {
		...
		if (medicalSurveyDTO.getCommonCreateAndUpateMarks() != null) {
			medicalSurvey.setCommonCreateAndUpateMarks(medicalSurveyDTO.getCommonCreateAndUpateMarks());
		}
