...
public class MedicalHistoryValidator implements Validator<MedicalHistoryDTO> {
	...
	public ValidationResult validate(MedicalHistoryDTO dto) {
		...
		if (Utils.isEmpty(dto.getMedicalOfficer())) {
			result.addErrorMessage(formID + ":medicalOfficer", UIInput.REQUIRED_MESSAGE_ID);
		}
