...
public class HealthProposalReportActionBean extends BaseBean implements Serializable {
	...
	public void exportHealthProposalReport() {
		...
		if (null != healthProposalReportList && healthProposalReportList.size() > 0) {
			...
			addErrorMessage("healthProposalListForm:healthProposalListTable", MessageId.THERE_IS_NO_DATA);
		}
	}
