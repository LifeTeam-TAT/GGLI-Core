...
public class PersonalAccidentProposalReportActionBean extends BaseBean implements Serializable {
	...
	public void exportExcel() {
		if (null != proposalReportList && proposalReportList.size() > 0) {
			...
			addErrorMessage("personalAcdntProposalListForm:personalAcdtProposalListTable", MessageId.THERE_IS_NO_DATA);
		}
	}
