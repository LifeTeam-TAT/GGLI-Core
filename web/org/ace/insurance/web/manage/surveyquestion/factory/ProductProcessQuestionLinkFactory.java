...
public class ProductProcessQuestionLinkFactory {
	public static ProductProcessQuestionLink getProductProcessQuestionLink(ProductProcessQuestionLinkDTO questionLinkDTO) {
		...
		if (questionLinkDTO.getCommonCreateAndUpateMarks() != null) {
			questionLink.setCommonCreateAndUpateMarks(questionLinkDTO.getCommonCreateAndUpateMarks());
		}
		return questionLink;
	...
	public static ProductProcessQuestionLinkDTO getProductProcessQuestionLinkDTO(ProductProcessQuestionLink questionLink) {
		...
		if (questionLink.getCommonCreateAndUpateMarks() != null) {
			questionLinkDTO.setCommonCreateAndUpateMarks(questionLink.getCommonCreateAndUpateMarks());
		}
