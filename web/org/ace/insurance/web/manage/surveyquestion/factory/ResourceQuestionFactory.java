...
public class ResourceQuestionFactory {
	public static ResourceQuestion getResourceQuestion(ResourceQuestionDTO resourceQuestionDTO) {
		...
		if (resourceQuestionDTO.getCommonCreateAndUpateMarks() != null) {
			resourceQuestion.setCommonCreateAndUpateMarks(resourceQuestionDTO.getCommonCreateAndUpateMarks());
		}
	...
	public static ResourceQuestionDTO getResourceQuestionDTO(ResourceQuestion resourceQuestion) {
		...
		if (resourceQuestion.getCommonCreateAndUpateMarks() != null) {
			resourceQuestionDTO.setCommonCreateAndUpateMarks(resourceQuestion.getCommonCreateAndUpateMarks());
		}
