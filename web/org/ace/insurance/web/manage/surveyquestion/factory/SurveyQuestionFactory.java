...
public class SurveyQuestionFactory {
	...
	public static SurveyQuestion getSurveyQuestion(SurveyQuestionDTO surveyQuestionDTO) {
		...
		if (surveyQuestionDTO.getCommonCreateAndUpateMarks() != null) {
			surveyQuestion.setCommonCreateAndUpateMarks(surveyQuestionDTO.getCommonCreateAndUpateMarks());
		}
	...
	public static SurveyQuestionDTO getSurveyQuestionDTO(SurveyQuestion surveyQuestion) {
		...
		if (surveyQuestion.getCommonCreateAndUpateMarks() != null) {
			surveyQuestionDTO.setCommonCreateAndUpateMarks(surveyQuestion.getCommonCreateAndUpateMarks());
		}
