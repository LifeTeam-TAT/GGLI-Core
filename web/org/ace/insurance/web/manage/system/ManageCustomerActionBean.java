...
public class ManageCustomerActionBean extends BaseBean implements Serializable {
	...
	@ManagedProperty(value = "#{CustomerHistoryService}")
	private ICustomerHistoryService customerhistoryService;

	public void setCustomerhistoryService(ICustomerHistoryService customerhistoryService) {
	...
	public void deleteCustomer(CUST001 cust001) {
		try {
			customerService.CreateHistoryAndRemoveCustomerById(cust001.getId());
