...
public class ManageICD10ActionBean extends BaseBean implements Serializable {
	...
	private List<ICD10> icd10FilterList;
	...
	public void createNewMedical() {
		...
		criteria = "";
		icd10 = new ICD10();
		PrimeFaces.current().resetInputs(":icd10EntryForm");
	...
	public String deleteICD10(ICD10 icd10) {
		try {
	...
	public void searchICD10() {
		icd10List = ICD10Service.findByCriteria(criteria);
		lazyModel = new LazyDataModelUtil<ICD10>(icd10List);
	}
	...
	public void selectICD10(ICD10 icd10) {
		PrimeFaces.current().dialog().closeDynamic(icd10);
	}
	...
	public List<ICD10> getIcd10FilterList() {
		return icd10FilterList;
	}

	public void setIcd10FilterList(List<ICD10> icd10FilterList) {
		this.icd10FilterList = icd10FilterList;
	}
