...
public class ManageOrganizationActionBean extends BaseBean implements Serializable {
	...
	public void createNewOrganization() {
		createNew = true;
		organization = new Organization();
		PrimeFaces.current().resetInputs(":organizationEntryForm");
	...
	public void addNewOrganization() {
		try {
			if (!isAreadyExistOrganization()) {
				...
				addWranningMessage(null, MessageId.ALREADY_ADD_ORGANIZATION, organization.getName());
			}
	...
	public boolean isAreadyExistOrganization() {
		return organizationService.isAlreadyExitOrganization(organization);
	}
