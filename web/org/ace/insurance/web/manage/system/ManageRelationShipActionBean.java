...
public class ManageRelationShipActionBean extends BaseBean implements Serializable {
	...
	public void search() {
		relationShipList = relationShipService.findByCriteria(criteria);
	}
	...
	public void addNewRelationShip() {
		try {
			if (!isAlreadyExist()) {
				...
				addWranningMessage(null, MessageId.ALREADY_ADD_RELATIONSHIP, relationShip.getName());
			}
	...
	public boolean isAlreadyExist() {
		return relationShipService.isAlreadyExistRelationShip(relationShip);
	}
