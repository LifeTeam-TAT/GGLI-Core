...
public class ManageTypesOfSportActionBean extends BaseBean implements Serializable {
	...
	public void search() {
		typesOfSportList = typesOfSportService.findByCriteria(criteria, 50);
	}
	...
	public void createNewTypesOfSport() {
		...
		typesOfSport = new TypesOfSport();
		criteria = "";
		PrimeFaces.current().resetInputs(":typesOfSportEntryForm");
	}

	public void prepareUpdateTypesOfSport(TypesOfSport typesOfSport) {
		createNew = false;
		this.typesOfSport = new TypesOfSport(typesOfSport);
	}
	...
	public String deleteTypesOfSport(TypesOfSport typesOfSport) {
		try {
